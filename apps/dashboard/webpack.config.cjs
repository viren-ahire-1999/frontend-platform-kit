...
module.exports = (_env, argv) => {
  ...
  return {
    ...
    devServer: {
      ...
      // Allow the shell (different origin) to fetch this remote's entry.
    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          // workspace:* is not a semver range, so skip the version check but
          // still enforce a single shared instance of the design system.
